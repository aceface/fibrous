...
(function() {
  var Fiber, Future, base, defineMemoizedPerInstanceProperty, fibrous, functionWithFiberReturningFuture, futureize, pkgInfo, proxyAll, proxyBuilder, synchronize, variant, _i, _len, _ref,
    __slice = [].slice;
  ...
  proxyBuilder = function(futureOrSync) {
    return function(that) {
      var func, ize, proto, result;
      result = typeof that === 'function' ? (ize = futureOrSync === 'future' && futureize || synchronize, func = ize(that), Object.getPrototypeOf(that) !== Function.prototype ? proto = Object.getPrototypeOf(that)[futureOrSync] : void 0, func.__proto__ = proto, Object.defineProperty(func, 'Array', {
        enumerable: true,
        configurable: true,
        get: function() {
          delete func.Array;
          return func.Array = ize((function(f, this_) {
            return function() {
      ...
      }), func) : Object.create(Object.getPrototypeOf(that) && Object.getPrototypeOf(that)[futureOrSync] || Object.prototype);
      result.that = that;
